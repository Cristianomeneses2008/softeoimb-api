...
class RefreshTokenRepository implements RefreshTokenRepositoryInterface
{
    ...
    {
        $this->database->table('Authenticator.OauthRefreshTokens')->insert([
    ...
    {
        $this->database->table('Authenticator.OauthRefreshTokens')
    ...
    {
        $refreshToken = $this->database->table('Authenticator.OauthRefreshTokens')
